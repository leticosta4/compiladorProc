...
void testaAnalex(){
    printf("\n\n[Análise Léxica -------------------]\n");
    if ((arqivoProc = fopen("./files/teste2.proc", "r")) == NULL){ printf("Arquivo de entrada da expressao nao encontrado!"); }
...
void testaAnasint(){
    printf("\n\n[Análise Sintática ----------------]\n");
    if ((arqivoProc = fopen("./files/socorro.proc", "r")) == NULL){ printf("Arquivo de entrada da expressao nao encontrado!"); }
    while(true){
        rcv_token = AnaLex(arqivoProc);
